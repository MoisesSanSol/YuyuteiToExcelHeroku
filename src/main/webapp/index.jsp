...
<option value="ir">- Index & Railgun (禁書目録＆超電磁砲)</option>
<option value="ir2.0">- Index & Railgun II (禁書目録II＆超電磁砲)</option>
...
<option value="kancolle">- Kantai Collection -Kancolle- (艦隊これくしょん -艦これ-)</option>
<option value="kancolle2.0">- Kantai Collection -Kancolle- Second Fleet (艦隊これくしょん -艦これ- 第二艦隊)</option>
<option value="kancolleext">- Kantai Collection -Kancolle- Abyssal Fleet (艦隊これくしょん -艦これ- 深海棲艦見ゆ Extra)</option>
<option value="kancolle3.0">- Kantai Collection -Kancolle- European Fleet (艦隊これくしょん -艦これ- 到着！欧州からの増派艦隊)</option>
<option value="kancolle4.0">- Kantai Collection -Kancolle- 5th Phase (艦隊これくしょん -艦これ-5th Phase)</option>
...
<option value="symphogear">- Symphogear (戦姫絶唱シンフォギア)</option>
<option value="symphogearg">- Symphogear G (戦姫絶唱シンフォギアG)</option>
<option value="symphogeargx">- Symphogear GX (戦姫絶唱シンフォギアGX)</option>
<option value="symphogearxd">- Symphogear XD UNLIMITED (戦姫絶唱シンフォギアXD UNLIMITED)</option>
<option value="symphogearxded">- Symphogear XD UNLIMITED EXTEND (戦姫絶唱シンフォギアXD UNLIMITED EXTEND)</option>
<option value="symphogearaxz">- Symphogear AXZ (戦姫絶唱シンフォギアAXZ)</option>
...
<p>Opciones:
  ...
  <select name="cantidad" form="serieslist">
